...
{
    public function testHttpHeadersInResponseWhenAProductModelIsCreated()
    {
...
JSON;
        ...
        $this->assertSame(
            'http://localhost/api/rest/v1/product-models/product_create_headers',
            $response->headers->get('location')
        );
        $this->assertSame('', $response->getContent());
    }

    public function testProductModelCreationWithFamily()
    {
        $client = $this->createAuthenticatedClient();
...
JSON;
    ...
    public function testProductModelCreationWithGroups()
    {
        $client = $this->createAuthenticatedClient();
...
JSON;
    ...
    public function testProductModelCreationWithCategories()
    {
        $client = $this->createAuthenticatedClient();
...
JSON;
    ...
    public function testProductModelCreationWithProductValues()
    {
        $client = $this->createAuthenticatedClient();
...
JSON;
    ...
    public function testProductModelCreationWithIgnoredProperties()
    {
        $client = $this->createAuthenticatedClient();
...
JSON;
    ...
    public function testProductModelCreationWithIdenticalIdentifiers()
    {
        $client = $this->createAuthenticatedClient();
...
JSON;
        ...
        $this->assertArrayHasKey('location', $response->headers->all());
        $this->assertSame(
            'http://localhost/api/rest/v1/product-models/same_identifier',
            $response->headers->get('location')
        );
        $this->assertSame('', $response->getContent());
    }
...
JSON;
        ...
        $this->assertArrayHasKey('location', $response->headers->all());
        $this->assertSame(
            'http://localhost/api/rest/v1/product-models/different',
            $response->headers->get('location')
        );
        $this->assertSame('', $response->getContent());
    }
...
JSON;
    ...
    public function testResponseWhenProductModelAlreadyExists()
    {
        $client = $this->createAuthenticatedClient();
